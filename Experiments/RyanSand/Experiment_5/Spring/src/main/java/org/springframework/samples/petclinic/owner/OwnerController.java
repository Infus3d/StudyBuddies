...
class OwnerController {
    ...
    //
    @RequestMapping(method = RequestMethod.GET, path = "/owners/nextday")
    public String saveOwner() {
    	...
    	if(chance == 6) o1 = new Owners(count, "Steve", "Smith", "Ames", "111-111-1111");
    	else if(chance == 7) o1 = new Owners(count, "Sally", "Johnson", "Iowa City", "432-485-3283");
    	else if(chance == 8) o1 = new Owners(count, "John", "Peterson", "Cedar Falls", "389-123-3820");
    	else if(chance == 9) o1 = new Owners(count, "Ryan", "Sand", "Waverly", "112-584-4234");
    	else o1 = new Owners(count, "Rafael", "Nadal", "Spain", "654-278-4173");
        ...
        count++;
    		...
    		if(ownersRepository.existsById(chance)) {
    			
    			ownersRepository.deleteById(chance);
