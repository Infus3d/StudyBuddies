...
@ServerEndpoint(value = "/chat/{group}/{username}")  // this is Websocket url
public class ChatSocket {
   ...
   * easiest.
	...
	@OnOpen
	public void onOpen(Session session, @PathParam("username") String username, @PathParam("group") Integer group) 
      throws IOException {
    ...
    // remove the user connection information
		...
		usernameGroupMap.remove(username);
	}
  ...
  // Gets the Chat history from the repository
	private String getChatHistory(Integer group) {
