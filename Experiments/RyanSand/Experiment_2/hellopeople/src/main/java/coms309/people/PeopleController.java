...
public class PeopleController {
    ...
    //Added functionality to create many generic people at once
    @PostMapping("/people/{number}")
    public @ResponseBody String createPeople(@PathVariable String number) {
       
    	for(int i = 0; i < Integer.parseInt(number); i++) {
    		 
    		Person p = new Person(""+i, ""+i, ""+i, ""+i);
    		peopleList.put(""+i, p);
    	}
    	
        return "People Copied";
    }
